  ...
  return (
    <main className="flex flex-col w-full policy-document">
      ...
      <section className={`p-8 mx-auto max-w-7xl`}>
        ...
        <p>
          By accessing <a href="https://qrmory.com">https://qrmory.com</a>, you
          ...
          using any other services provided by RAVENCI.{" "}
        </p>
        <p>
          We, RAVENCI, reserve the right to review and amend any of these Terms
        ...
        <p>
          ...
          restrictions or the Terms of Service, and may be terminated by RAVENCI
          at any time.{" "}
        </p>
        ...
        <p>
          ...
          on this website, even if RAVENCI or an authorized representative has
        ...
        <h3>Links</h3>
        <p>
          RAVENCI has not reviewed all of the sites linked to its website and is
          ...
          by RAVENCI of the site. Use of any such linked site is at your own
