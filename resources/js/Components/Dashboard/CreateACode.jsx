...
import WebsiteQR from "../Controls/WebsiteQR";
import FacebookQR from "../Controls/FacebookQR";
import InstagramQR from "../Controls/InstagramQR";
import TwitterQR from "../Controls/TwitterQR";
import YoutubeQR from "../Controls/YoutubeQR";
import TextQR from "../Controls/TextQR";

const CreateACode = (props) => {
  // States
  ...
  return (
    <>
      <div>
        <h1 className="text-left text-xl font-bold">Create a New Code</h1>
