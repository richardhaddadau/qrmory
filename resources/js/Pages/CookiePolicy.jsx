...
const CookiePolicy = () => {
  return (
    <>
      <Helmet>
        <title>Cookie Policy - QRmory</title>
      </Helmet>
      <Standard>
        ...
        <main className="mx-auto py-8 px-4 w-full max-w-7xl policy-document">
          ...
          <p>
            ...
            <a href="https://qrmory.com">https://qrmory.com</a>. In such a case,
            we may be unable to provide you with some of your desired content
            and services.{" "}
          </p>
